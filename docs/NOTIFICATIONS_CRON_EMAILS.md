...
| Recuperar outbox contable V2 | `https://carzoneaccesorios.com/api/cron/process-accounting-outbox-v2` | GET o POST | Cada 5 minutos | `Authorization: Bearer <CRON_SECRET>` | Reclama lotes acotados, recupera leases vencidos y aplica reintentos con backoff. Solo crea borradores; nunca publica partidas. | Alta |
