...
function cleanup() {
  psql(`
    ...
    delete from public.accounting_outbox where source_id in (select id from public.accounts_receivable_payments where receivable_id = any(array['${ids.normalReceivable}','${ids.historicalReceivable}','${ids.rejectReceivable}','${ids.cancelledReceivable}','${ids.paidReceivable}','${ids.concurrentReceivable}']::uuid[]));
