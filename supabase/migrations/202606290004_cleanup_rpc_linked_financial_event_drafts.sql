-- Phase 2C follow-up: cleanup generated drafts linked to prefixed financial events.
-- Draft generator uses PC-* entry numbers, so cleanup must follow the financial_event UUID link.
