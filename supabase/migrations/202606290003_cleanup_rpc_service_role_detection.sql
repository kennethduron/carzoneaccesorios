-- Phase 2C follow-up: use Supabase auth.role() for service-role cleanup calls.
-- Keeps cleanup unavailable to contadora even though she now has accounting:manage.
