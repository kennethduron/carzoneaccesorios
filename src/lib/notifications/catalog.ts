...
export const notificationCatalog = [
  ...
  { type: "payment.transfer_review", module: "pagos", label: "Transferencia en revision", defaultSeverity: "warning", defaultRoles: ["business_owner", "admin"], emailDefault: true },
  ...
  { type: "order.logistics_review", module: "pedidos", label: "Revision logistica requerida", defaultSeverity: "warning", defaultRoles: ["bodega", "admin"], emailDefault: false },
  ...
  { type: "inventory.critical_low_stock", module: "inventario", label: "Stock bajo critico", defaultSeverity: "critical", defaultRoles: ["business_owner", "admin", "bodega"], emailDefault: true },
  ...
  { type: "wholesale.request_pending_24h", module: "mayoristas", label: "Solicitud pendiente mas de 24h", defaultSeverity: "warning", defaultRoles: ["business_owner", "admin"], emailDefault: true },
  ...
  { type: "fiscal.cai_expiring", module: "sistema", label: "CAI proximo a vencer", defaultSeverity: "warning", defaultRoles: ["technical_owner", "business_owner", "contadora"], emailDefault: true },
  ...
  { type: "fiscal.range_low", module: "sistema", label: "Rango fiscal proximo a agotarse", defaultSeverity: "warning", defaultRoles: ["technical_owner", "business_owner", "contadora"], emailDefault: true },
  ...
  { type: "fiscal.correlative_invalid", module: "sistema", label: "Correlativo fiscal bloqueado o invalido", defaultSeverity: "critical", defaultRoles: ["technical_owner", "business_owner", "contadora"], emailDefault: true },
  ...
  { type: "system.backup_failed", module: "sistema", label: "Backup fallido", defaultSeverity: "critical", defaultRoles: ["technical_owner"], emailDefault: true, technicalOnly: true },
  { type: "system.email_failed", module: "sistema", label: "Correo fallido", defaultSeverity: "critical", defaultRoles: ["technical_owner"], emailDefault: true, technicalOnly: true },
  ...
  { type: "system.critical_error", module: "sistema", label: "Error critico", defaultSeverity: "critical", defaultRoles: ["technical_owner"], emailDefault: true, technicalOnly: true },
  ...
  { type: "customer.order_cancelled", module: "pedidos", label: "Cancelacion de pedido al cliente", defaultSeverity: "warning", defaultRoles: [], emailDefault: true },
