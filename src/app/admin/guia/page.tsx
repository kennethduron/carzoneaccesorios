...
const roleGuides: ScopedGuide[] = [
  {
    ...
    description: "Supervisa ventas, pedidos, reportes, clientes y mayoristas según sus permisos.",
    steps: [
...
const processSteps: ScopedStep[] = [
  ...
  { title: "Cargar inventario", href: "/admin/inventario", detail: "Registra entradas reales y revisa mínimos antes de vender.", permissions: ["inventory:manage"] },
  { title: "Preparar pedido", href: "/admin/pedidos?task=to_prepare", detail: "Identifica pedidos confirmados y avanza preparación, empaque o envío.", permissions: ["orders:manage_logistics"] },
  ...
  { title: "Configurar redes", href: "/admin/configuracion", detail: "Mantén datos públicos, enlaces y contacto actualizados.", permissions: ["commercial_settings:manage"] },
