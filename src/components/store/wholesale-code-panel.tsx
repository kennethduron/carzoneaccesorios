      ...
      <section className="rounded-lg border border-black/10 bg-white p-4">
        ...
        <form onSubmit={applyCode} className="flex gap-2">
          ...
          <button
            ...
            className="rounded-md bg-[#e4252c] px-4 py-2 text-sm font-medium text-white disabled:opacity-60"
          >
        ...
        {wholesaleAccount ? (
          <div className="mt-3 rounded-md bg-[#f4f4f5] p-3 text-sm text-black/65">
            <p className="font-medium text-[#080808]">{wholesaleAccount.businessName}</p>
      ...
      {loginHref ? (
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/45 px-4" role="presentation">
          <section
            ...
            aria-modal="true"
            role="dialog"
            className="w-full max-w-md rounded-lg border border-black/10 bg-white p-5 text-[#080808] shadow-xl"
          >
            ...
            <div className="mt-5 grid gap-2 sm:grid-cols-2">
              ...
              <button
                ...
                className="rounded-md border border-black/10 bg-white px-4 py-2 text-sm font-medium text-[#080808] hover:bg-[#f4f4f5]"
              >
                Cancelar
              </button>
            </div>
